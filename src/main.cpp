...
bool parseArgs(int ac, char *av[]){
	try{
		...
		desc.add_options()
				("help", "TODO")
				("noautorun",po::bool_switch(),"prevents system to run on startup")
				("headless", po::bool_switch(),"set to headless mode")
				("shutdown", po::bool_switch(), "shutdown operating system once navigation system is closed")
				("collectdata", po::bool_switch(), "collect and save data for further analysis")
		;
