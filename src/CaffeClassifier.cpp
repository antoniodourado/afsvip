...
CaffeClassifier::CaffeClassifier() {
	...
	const string model_file = "Assets/DLModel/deploy.prototxt";
	const string trained_file = "Assets/DLModel/model.caffemodel";
	const string label_file = "Assets/DLModel/labels.txt";
	const string mean_file = "Assets/DLModel/mean.binaryproto";
